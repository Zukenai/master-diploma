...
def build_explanation(
    ...
    overlap_summary = "; ".join(
        ...
        f"claims {len(item.overlap_signals.get('claim_overlap_terms', []))}"
    ...
    return (
        ...
        "The explanation considers title, keyword, and claim-support facets instead of raw lexical match alone. "
